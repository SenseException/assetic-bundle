...
<?php $view['slots']->start('stylesheets') ?>
    <?php foreach($view['assetic']->stylesheets('stylesheet1.css, stylesheet2.css, @TestBundle/Resources/css/bundle.css, @TestIgnoreBundle/Resources/css/bundle.css') as $url): ?>
